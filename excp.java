//Demonstrate the concept of exception handling (user defined exception is a must)
...
{	
	...
	public static void main(String args[]) throws IOException, PNRLengthException
	{
			...
			String[] cars = {"Maruti Suzuki Swift", "Hyundai i20","Tata Indica","Honda Amaze","Toyota Innova", "Mahindra XUV 300"};
		do
    	{
			System.out.print("\nEnter PNR: ");
			pnr=reader.readLine();
